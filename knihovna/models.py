...
class Recenze(models.Model):
    ...
    text = models.TextField(verbose_name='Text recenze', help_text='tady napis recenzi')
    HODNOCENI_KNIHY = (
        (0, ''),
        (1, '*'),
        (2, '**'),
    ...
    hodnoceni = models.PositiveSmallIntegerField(verbose_name='hodnoceni knihy', default=5, choices=HODNOCENI_KNIHY)
    ...
    def __str__(self):
        return f'{self.recenzent}, {self.hodnoceni}, {self.upraveno}'
